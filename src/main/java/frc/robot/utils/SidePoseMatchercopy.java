 ...
 */
public class SidePoseMatchercopy {
  ...
  private static final List<Pose2d> blueLeftPoses1 =
      Arrays.asList(
          new Pose2d(new Translation2d(3.93, 2.75), new Rotation2d(Math.toRadians(63.26))),
  ...
  private static final List<Pose2d> blueLeftPoses =
      Arrays.asList(
          ...
          new Pose2d(new Translation2d(5.7, 3.87), new Rotation2d(Math.toRadians(179.93))), // right
  ...
  private static final List<Pose2d> blueRightPoses =
      Arrays.asList(
          new Pose2d(new Translation2d(3.75, 3.06), new Rotation2d(Math.toRadians(59.57))), // left
          new Pose2d(new Translation2d(5.22, 3.06), new Rotation2d(Math.toRadians(120.16))), // left
          new Pose2d(new Translation2d(5.7, 4.2), new Rotation2d(Math.toRadians(179.96))), // left
