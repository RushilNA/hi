...
public class Lynkalighnmentright extends Command {
  ...
  public void initialize() {
    ...
    Pose2d targetPose = SidePoseMatcher.getBackedUpClosestRightPosec(s_Swerve.getPose());
  ...
  public void execute() {
    ...
    s_Swerve.drive3(new Translation2d(xVal, yVal).times(speed), rotationVal * 2, precise);
  }
