  ...
  public class Robot extends LoggedRobot {
    ...
    private void configureBindings() {
      ...
      joystick
          ...
          .whileTrue(
              new ParallelCommandGroup(
                  shoot.cmd(0.3).alongWith(new Rumbleintake(shoot, joystick)), elevator1.runOnce(() -> elevator1.resetenc())))
                  ...
                  drivetrain
                      ...
                      .andThen(
                          drivetrain.autoAlighnTopose(
                              SidePoseMatcher.getClosestPose(drivetrain.getPose())).alongWith(new Elevatorcmd(elevator1, 2, true)))
                              .until(
                                () ->
                                    drivetrain.isAtTarget(
                                        ...
                                        drivetrain.getPose()) && 
                                        elevator1.autoncheck(2))
                                        .andThen(new Elevatorcmd(elevator1, 2, true)).alongWith(shoot.cmd(-0.2))).until(()-> shoot.hasVelocityautoalighn())
                                        .andThen(() ->
                                        drivetrain
                                            .autoAlighnTopose(
                                                SidePoseMatcher.getBackedUpClosestPose(drivetrain.getPose())))
      ...
      joystick
          ...
          .whileTrue(
              new ConditionalCommand(
                  ...
                  new ConditionalCommand(hyper, Positionl2, ()-> Constants.getCoralstate() == Constants.coralstate.Holding), // algae
      ...
      joystick
          ...
          .whileTrue(
              new ConditionalCommand(
                  ...
                  new ConditionalCommand(hyperl3, Positionl3, ()-> Constants.getCoralstate() == Constants.coralstate.Holding),
                  () -> Constants.getRobotState() != Constants.RobotState.ALGEA))
          .whileFalse(
              new SequentialCommandGroup(
                  elevator1.Motionmagictoggle(0),
