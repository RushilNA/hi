...
public class climbsub extends SubsystemBase {
  ...
  private TalonFX climbm = new TalonFX(30, "Drivetrain");
  ...
  public Command pid(double position) {
    return new Command() {
      ...
      public void execute() {
        ...
        double speed = pidup.calculate(climbm.getPosition().getValueAsDouble());
        climbm.set(speed);
      }
  ...
  public Command down(double position) {
    return new Command() {
      ...
      public void execute() {
        ...
        if (Math.abs(climbm.getPosition().getValueAsDouble()) < 4.058349609375) {
  ...
  public Command up(double position) {
    return new Command() {
      ...
      public void execute() {
        ...
        if (climbm.getPosition().getValueAsDouble() < 2.023) {
